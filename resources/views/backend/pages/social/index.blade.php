...
@section('content')
    ...
    <div class="invoice-create-btn mb-1">
        <a href="/admin/social/create" class="btn btn-primary glow invoice-create" role="button"
           aria-pressed="true">
            Создать</a>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Социальные сети</h4>
                    </div>
                                ...
                                <table class="table zero-configuration">
                                    ...
                                    @foreach ($socials as $social)
                                        <tr>
                                            <td>{{$social->id }}</td>
                                            <td>
                                                <a href="{{route('social.edit',$social->id)}}">{{$social->name }}</a><br>
                                            </td>
                                            <td>{{$social->link}}</td>
                                            <td>
                                                <i class="bx bxs-circle {{($social->active)?'success':'danger'}}  font-small-1 mr-50"></i>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tfoot>
