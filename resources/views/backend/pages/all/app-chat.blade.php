      ...
      <header class="d-flex justify-content-between align-items-center border-bottom px-1 py-75">
        <div class="d-flex align-items-center">
          ...
          <div class="avatar chat-profile-toggle m-0 mr-1">
            <img src="{{asset('/adm/app-assets/images/portrait/small/avatar-s-26.jpg')}}" alt="avatar" height="36" width="36" />
          ...
          <div class="chat-content">
            <div class="chat">
              <div class="chat-avatar">
                <a class="avatar m-0">
                  <img src="{{asset('/adm/app-assets/images/portrait/small/avatar-s-11.jpg')}}" alt="avatar" height="36"
                    width="36" />
                </a>
              </div>
              <div class="chat-body">
            ...
            <div class="chat chat-left">
              <div class="chat-avatar">
                <a class="avatar m-0">
                  <img src="{{asset('/adm/app-assets/images/portrait/small/avatar-s-26.jpg')}}" alt="avatar" height="36"
                    width="36" />
                </a>
              </div>
              <div class="chat-body">
...
<section class="chat-profile">
  <header class="chat-profile-header text-center border-bottom">
    ...
    <div class="my-2">
      <div class="avatar">
        <img src="{{asset('/adm/app-assets/images/portrait/small/avatar-s-26.jpg')}}" alt="chat avatar" height="100" width="100">
      </div>
