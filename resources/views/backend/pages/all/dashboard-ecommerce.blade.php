            ...
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-end">
                ...
                <div class="dashboard-content-right">
                  <img src="{{asset('/adm/app-assets/images/icon/cup.png')}}" height="220" width="220" class="img-fluid"
                  ...
                  <tbody>
                    <tr>
                      <td class="pr-75">
                        <div class="media align-items-center">
                          <a class="media-left mr-50" href="#">
                            <img src="{{asset('/adm/app-assets//adm/app-assets/images/portrait/small/avatar-s-16.jpg')}}" alt="avatar"
                              class="rounded-circle" height="30" width="30">
                          </a>
                          <div class="media-body">
              ...
              <tbody>
                <tr>
                  <td class="py-1 line-ellipsis">
                    <img class="rounded-circle mr-1" src="{{asset('/adm/app-assets/images/icon/fs.png')}}" alt="card" height="24"
                ...
                <tr>
                  <td class="py-1 line-ellipsis">
                    <img class="rounded-circle mr-1" src="{{asset('/adm/app-assets/images/icon/puma.png')}}" alt="card" height="24"
                      width="24">Puma Shoes
                  </td>
                  <td class="py-1">
                ...
                <tr>
                  <td class="py-1 line-ellipsis">
                    <img class="rounded-circle mr-1" src="{{asset('/adm/app-assets/images/icon/nike.png')}}" alt="card" height="24"
                ...
                <tr>
                  <td class="py-1 line-ellipsis">
                    <img class="rounded-circle mr-1" src="{{asset('/adm/app-assets/images/icon/one-plus.png')}}" alt="card"
                ...
                <tr>
                  <td class="py-1 line-ellipsis">
                    <img class="rounded-circle mr-1" src="{{asset('/adm/app-assets/images/icon/google.png')}}" alt="card"
