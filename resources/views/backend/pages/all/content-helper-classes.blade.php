      ...
      <div class="card-text">
        ...
        <div class="bd-example">
          <h1 class="text-hide my-2"
            style="background-image: url('{{asset('/adm/app-assets/images/logo/logo.png')}}'); width: 30px; height: 26px;">
            Bootstrap</h1>
        </div>
        <pre><code class="language-html">
                &lt;h1 class="text-hide my-2" style="background-image: url('/adm/app-assets/images/logo/logo.png'); width: 30px; height: 26px;"&gt;Bootstrap&lt;/h1&gt;
                </code></pre>
      </div>
    </div>
  </div>
