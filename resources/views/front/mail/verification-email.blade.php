                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div
                                        ...
                                        Здравствуйте.<br></br>
                                        Вы получили это сообщение так как мы получили запрос на подтверждение e-mail
                                        на сайте офицеру.ру.
                                        <br>
                                        Для подтверждения перейдите по ссылке ниже
                                        <br><br>
                                        <a href="{!! $data['VerificationEmail'] !!}" >Подтвердить e-mail </a>
                                    </div>
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div
                                        ...
                                        <a href="https://oficeru.ru" style="color:#2F67F6">Офицеру.ру</a>
                                    </div>
