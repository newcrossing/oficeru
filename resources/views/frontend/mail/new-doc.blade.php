                                                ...
                                                <table class="center" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="text-top-white"
                                                            ...
                                                            <multiline>
                                                                <a href="https://oficeru.ru/" target="_blank"
                                                                   class="link-white-u"
                                                                   style="color:#ffffff; text-decoration:underline"><span
                                                                        class="link-white-u"
                                                                        style="color:#ffffff; text-decoration:underline">Главная</span></a>
                                                            </multiline>
                                                        </td>
                                                        <td class="img"
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="text"
                                                 style="color:#2c2c2c; font-family:Arial,sans-serif; font-size:16px; line-height:20px; text-align:left">
                                                Здравствуйте. <br><br>
                                                Вы получили это сообщение так как подписадись на уведомления о
                                                новых документах на сайте офицеру.ру.
                                                <br>
                                                <br>
                                            </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <div class="text-white-m-center"
                                                                ...
                                                                Правовая поддержка военнослужащих
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="text-white-m-center"
                                                                ...
                                                                <br/>
                                                                Email:
                                                                <a href="mailto:oficeru.ru@yandex.ru"
                                                                   target="_blank" class="link-white"
                                                                   style="color:#ffffff; text-decoration:none"><span
                                                                        class="link-white"
                                                                        style="color:#ffffff; text-decoration:none">oficeru.ru@yandex.ru</span></a>
                                                            </div>
                                                            <div style="font-size:0pt; line-height:0pt;"
                                                                 class="mobile-br-15"></div>
