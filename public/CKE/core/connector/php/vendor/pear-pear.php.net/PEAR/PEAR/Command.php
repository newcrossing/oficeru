...
class PEAR_Command
{
    ...
    /**
     * Get instance of frontend_old object.
     *
    ...
    /**
     * Load current frontend_old class.
     *
     * @param string $uiclass Name of class implementing the frontend_old
     *
     * @return object the frontend_old object, or a PEAR error
     */
    ...
    /**
     * Set current frontend_old.
     *
     * @param string $uitype Name of the frontend_old type (for example "CLI")
     *
     * @return object the frontend_old object, or a PEAR error
     */
