...
class HttpCache implements HttpKernelInterface, TerminableInterface
{
    ...
    {
        //  catch exceptions and implement a 500 error page here? -> in Varnish, there is a built-in error page mechanism
    ...
    protected function forward(Request $request, $catch = false, Response $entry = null)
    {
        ...
        // : we probably need to also catch exceptions if raw === true
