...
$(document).ready(function(){
	...
	$('.carousel-posts-nav-prev').on('click', function(){
		$(this).parents('.grid-container').find('.carousel-posts').trigger('../../../../../../index.htm'/*tpa=http://smartik.ws/demo/themeforest/html/gustos/assets/js/owl.prev*/);
	});
	$('.carousel-posts-nav-next').on('click', function(){
		$(this).parents('.grid-container').find('.carousel-posts').trigger('../../../../../../index.htm'/*tpa=http://smartik.ws/demo/themeforest/html/gustos/assets/js/owl.next*/);;
	});
	...
	$('.carousel-posts-nav-prev').on('click', function(){
		$(this).parents('.grid-container').find('.home-carousel-posts').trigger('../../../../../../index.htm'/*tpa=http://smartik.ws/demo/themeforest/html/gustos/assets/js/owl.prev*/);
	});
	$('.carousel-posts-nav-next').on('click', function(){
		$(this).parents('.grid-container').find('.home-carousel-posts').trigger('../../../../../../index.htm'/*tpa=http://smartik.ws/demo/themeforest/html/gustos/assets/js/owl.next*/);;
	});
